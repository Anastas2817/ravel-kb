...
> Заполняется по мере готовности. Пока — мокап выше.

- [ ] «До»: реальная карта автора из Excalidraw/Coggle — пример неструктурированного конспекта, который Ravel призван заменить (без привязки к личным данным)
